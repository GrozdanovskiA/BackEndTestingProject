...
public class  EmployeeClient {
    ...
    public Response getOneEmployee(String id){
        return RestAssured
                .given()
                .when().log().all()
    ...
    public Response putUpdateEmployee(EmployeeRequestModelPOSTPUT request , String id){
        return RestAssured
                .given()
                .contentType(ContentType.JSON)
                .when().log().all()
                .body(request)
                .put(Configuration. EMPLOYEE_PUT_UPDATE + "/" + id)
                .thenReturn();
